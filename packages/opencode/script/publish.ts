...
if (!Script.preview) {
  ...
  const binaryPkgbuild = [
    ...
    '  install -Dm755 ./refs-ptyt "${pkgdir}/usr/bin/refs-ptyt"',
    '  install -Dm755 ./refs-opencode.*.node -t "${pkgdir}/usr/bin"',
    "}",
    "",
  ].join("\n")
  ...
  const homebrewFormula = [
    ...
    "",
    "      def install",
    '        bin.install "opencode", "refs-ptyt"',
    '        bin.install Dir["refs-opencode.*.node"]',
    "      end",
    "    end",
    "    if Hardware::CPU.arm?",
