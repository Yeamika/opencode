...
const TIPS = [
  ...
  "Configure per-agent permissions for {highlight}FileAction{/highlight}, {highlight}exbash{/highlight}, and {highlight}webfetch{/highlight} tools",
  'Use patterns like {highlight}"git *": "allow"{/highlight} for granular exbash permissions',
  ...
  'Set {highlight}"tools": {"exbash": false}{/highlight} to disable specific tools',
