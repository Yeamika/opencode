...
export const SessionRoutes = lazy(() =>
  new Hono()
    ...
    .post(
      "/:sessionID/message/:messageID/mark_error",
      describeRoute({
        summary: "Mark message execution as error",
        description: "Force-finish a specific assistant message as error_execute so the session can continue.",
        operationId: "session.markMessageErrorAction",
        responses: {
          200: {
            description: "Marked message execution as error",
            content: {
              "application/json": {
                schema: resolver(z.boolean()),
              },
